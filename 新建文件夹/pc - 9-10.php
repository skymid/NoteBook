    ...
    <div data-options="region:'center',border:false" >	
		...
		<div class="easyui-layout" style="width:100%;height:100%;">  
			...
			<div data-options="region:'north'" style="height:80px;">
				...
				<div id="p" class="easyui-panel" style="width:99%;height:99%;padding:15px;background:#fafafa;" data-options='border:false'>   
						 ...
						 <div id="note_edit" style="padding:10px">
							<form id="it_send_form" method="post"> 
									<div style="padding:10px">
										<input id="title_" class="easyui-textbox"  data-options="label: ' 标题：',labelWidth:50" style="width:95%"> 																 					
